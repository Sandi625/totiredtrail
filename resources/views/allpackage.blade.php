...
@endforeach
  ...
  <div class="contactOptions">
    ...
    <a href="https://www.instagram.com/vamosadventure.idn/" target="_blank" rel="noopener" class="contactOption">
        <abbr title="Instagram">
            <img src="https://img.icons8.com/ios-glyphs/60/ffffff/instagram-new.png" alt="Instagram Icon">
        </abbr>
    </a>

    <a href="https://wa.me/628133088586" target="_blank" rel="noopener" class="contactOption">
        <abbr title="WhatsApp">
    ...
    <a href="mailto:vamosadventure.idn@gmail.com" class="contactOption">
        <abbr title="Email">
