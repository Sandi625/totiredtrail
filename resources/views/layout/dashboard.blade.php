...
<head>
    ...
    <title>To tired trail - @yield('title')</title>

    <meta name="description" content="Sistem Informasi  To Tired Trail" />
    <meta name="keywords" content="dashboard, bootstrap 5, To Tired Trail">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold">Admin TTT</span>
                    </a>
                        ...
                        <div class="container-xxl">
                            <div
                                ...
                                <div>
                                    ...
                                    Powered By <a href="">Dhani Irja And Sandi Permadi</a>
